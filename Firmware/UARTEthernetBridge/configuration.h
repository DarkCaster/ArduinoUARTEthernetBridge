...
#define UART_POLL_INTERVAL_US_TCP 4096
#define UART_POLL_INTERVAL_US_UDP 4096
...
#define UART_AGGREGATE_MULTIPLIER 4
#define UART_POLL_INTERVAL_US_TCP 2048
#define UART_POLL_INTERVAL_US_UDP 2048
#define DATA_BUFFER_SIZE (UART_BUFFER_SIZE*100)
#define DATA_PAYLOAD_SIZE (UART_BUFFER_SIZE*UART_AGGREGATE_MULTIPLIER)
#define UART_COUNT 3
